"""
Akshavedamsa (D45) calculation.

According to Brihat Parashara Hora Shastra.

Each sign is divided into forty-five equal parts.
...
def akshavedamsa(
    longitude: float,
) -> AkshavedamsaPosition:
    """
    Compute Akshavedamsa (D45).
